...
import static org.springframework.social.daum.api.DaumErrors.*;
...
import org.springframework.social.daum.api.DaumError;
 ...
 */
public class DaumErrorHandler extends DefaultResponseErrorHandler {
    ...
    public void handleError(ClientHttpResponse response) throws IOException {
        ...
        DaumError error = mapper.readValue(errorString, DaumError.class);
        handleFacebookError(response.getStatusCode(), error);
    }

    void handleFacebookError(HttpStatus statusCode, DaumError error) {
